					...
					>
						...
						>
							...
							<p>
								...
								decades around 1300 can be understood as part of a rising appetite
								for vernacular history amongst the gentry and aristocracy, who seem
								to have appreciated the combination of diagrammatic account of
								the royal lineage enlivened by pithy, moralistic texts describing
								each reign. Using Houghton Library MS Typ 11 as a central example,
								this paper will argue that additionally these genealogies are part
								of a wider fascination with kinship and consanguinity, which manifested
								itself in contemporary visual culture in a variety of contexts.
							</p>
							...
							<p>
								...
								Houghton Library MSS Typ 11 and Richardson 35, which relate the history
								of England in the format of a roll and a codex, respectively.
								Focusing on these formats and other features that predicate the use
								of these objects, this paper discusses the ways in which each embodies
								a different epistemology and aspires to shape not only the perception
								of history, but its production as well.
							</p>
							...
							<p>
								...
								the noble art of hunting and chivalric ideals. Two manuscripts in the
								Houghton Library illustrate the significant investment that nobles made
								into their books on such subjects; they also exemplify the talented
								response of contemporary scribes and illuminators. The present paper
								explores the specific context in which they were made, the motivations
						...
						>
							...
							<p>
								...
								goods to be shown, or given as gifts by authors or princes.  In the first case
								authors dedicated their works to powerful rulers to gain their protection;
								in the second case princes used illuminated manuscripts to strengthen their
								alliances. The choice of the texts and their illustrations was strictly
								related with the culturalcontext of the court and the tastes of the prince.
								This paper consider as a case study Ferrara in the XV century analyzing the
								manuscripts Houghton Library MSS  Typ 226 and Typ 227 in the wider context
							...
							<p>
								...
								at the end of the 14th Century. In this paper Polistorio's illuminations,
								traditionally referred to a North-Italian artist, will be recognized as the product
								of a Florentine workshop active in Mantua. They will be attributed to Don Simone
								Camaldolese, one of the most important illuminators in 14th Century Tuscany.
								The manuscript will be discussed in the context of the cultural relations
							...
							<p>
								...
								participation in government, and service to the state when elected as an official.
								Prominent patrician families, therefore, built up substantial reference collections
								of relevant legal statutes and records of commissions of office. This paper
								examines the roles of painting in such documents to frame reception of the texts,
								and to memorialize the recipients, drawing from manuscripts in Boston-area
								collections, including the following in the exhibition: Commission to Vincenzo
								Gritti as lieutenant of Udine, 1546 (Gardner 2.a.2.1); Commission to Girolamo
								Morosini as Captain of Brescia, 1547 (Gardner, 2.c.2.2); Statuta veneta, c. 1346
								(Houghton Library MS Typ.140); Commission to Gasparo Molin as procurator de citra,
								1526, (Houghton Library MS Typ 543); Commission to Lorenzo Bembo as captain of
							...
							<p>
								...
								only recently been connected with a long-forgotten phase of illumination produced
								in Rome during the Great Western Schism. This paper will examine the artists
								working in the manuscript's different campaigns of decoration and it will provide
								a context for its patronage and original destination. The Pontifical's complex
							...
							<p>
								...
								historiated initials for the Temporale chants; dated around 1430, they can be
								attributed to a miniaturist known as the Donato Master. Another gradual in
								the British Library has recently been identified as its counterpart, a Sanctorale
								illuminated by the same miniaturist, and sharing its provenance.
								The two graduals and related liturgical manuscripts enable further evaluation
							...
							<p>
								...
								commissioned an elaborate new set of fourteen illuminated choir books,
								now dispersed among public and private collections in the United States and
								Europe (including Boston Public Library, MSS pf Med 97 and 120).
								The Benedictine patrons of the manuscripts are depicted numerous times throughout
								the volumes; this discussion explores how and where they appear and their
								significance for the books’ use. In addition, a special focus of this paper will
								be the striking illustrations by one of the artists responsible for the
						...
						>
							...
							<p>
								...
								to 14th century) that document economic and legal interactions between the
								Cistercian abbey of Sawley (founded in 1147-8) and its local benefactors.
								Most of these charters were produced as indentures (chirographs) and an initial
								comparison with charters entered in the abbey’s cartulary (mid-14th, British
								Museum MS Harley 112) raises the question of the location of the deeds prior
								to the abbey’s dissolution (1536). Were these the halves kept in the archives
								of the abbey or were they the portions distributed to the other party in the
								transaction? Though a struggling institution, Sawley abbey boasted a library,
								which contained the earliest mappa mundi produced in England (in the late
								12th to early 13th century, possibly at Sawley, but more likely at Durham,
								now at Corpus Christi College, Cambridge, MS. 66). One of Sawley’s abbots
								(between 1223-1234), Stephen of Sawley (or of Easton) composed devotional
								treatises addressed to the Virgin Mary. While situating the Houghton documents
								within the broader scribal and archival activities of Sawley, this paper will
								also examine the place of writing in the abbey’s activities, and specifically
								the ways in which writing was strategically deployed to maintain its networks
							...
							<p>
								...
								which made manuscripts. The Augustine canonesses of St Agnes wrote and
								richly illuminated manuscripts, most famously the Fagel Missal (Dublin, TCD),
								executed in 1459 and 1460. In 1454 or 1457 a convent of Franciscan tertiaries
								moved in across the street and began writing and illuminating vernacular
								manuscripts with great speed and efficiency, and presumably at a lower price
								than their Latin-writing neighbors. They offered manuscripts with various
								degrees of finish, which could be completed by adding professionally made
								miniatures on single leaves. This paper will place Boston Public Library q.Med.
								86 in its context of production, based on a comparative analysis of its
								calendar, script, and decoration. In so doing, the competitive practices that
								shaped manuscript production in Delft are also considered, practices that
