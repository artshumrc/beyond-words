                        ...
                        <div className="row flex-center">
                            <div className="col-sm-12">
                              <img className="catalog-image" src="/images/catalog.png"/>
                                <p>The catalog <em>Beyond Words</em> features illuminated manuscripts from nineteen Boston-area
                                    ...
                                    and early printed books, many of them little known before now. <em>Beyond Words</em> also
                                ...
                                <p>Major support for the publication of the catalog was provided by Daniel and Joanna
